...
window.openDetailKaryawan = async function(id, activeTab = 'personal') {
  ...
  const tabs = ['personal','employment','schedule','documents','history']
  const tabLabels = { personal:'Personal', employment:'Employment', schedule:'Schedule', documents:'Documents', history:'History' }
